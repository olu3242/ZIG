...
export default function OrganizationSettingsError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="rounded-lg border border-[var(--zig-amber)] bg-[var(--zig-paper-2)] p-5">
      <h1 className="font-display text-xl font-semibold">Organization settings need a refresh</h1>
