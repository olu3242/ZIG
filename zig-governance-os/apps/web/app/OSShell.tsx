      ...
      <div className="mx-auto flex h-[73px] w-full max-w-[1680px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-sm">
          ...
          <form action={logoutAction}>
            <button
              type="submit"
              className="rounded-lg border border-zinc-700 bg-zinc-900/50 px-3 py-2 font-medium text-zinc-400 backdrop-blur-md transition-all hover:border-red-400/50 hover:text-red-200"
              aria-label="Log out"
            >
              Log out
            </button>
